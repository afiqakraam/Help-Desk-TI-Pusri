	...
	<div id="wrapper">
		<div class="vertical-align-wrap">
			<div class="vertical-align-middle auth-main">
				<div class="auth-box">
                    <div class="top">
                        <img src="{{ asset('templates/assets/images/pusri.svg') }}" width="100px" alt="Lucid">
                    </div>
					<div class="card">
                        <div class="header">
                        ...
                        <div class="body">
                            <form class="form-auth-small" action="{{ route('login.post') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="signin-email" name="email" required autofocus placeholder="Email">
                                    @if ($errors->has('email'))
